<h2><a href="https://leetcode.com/problems/best-reachable-tower">4187. Best Reachable Tower</a></h2><h3>Medium</h3><hr><p>You are given a 2D integer array <code>towers</code>, where <code>towers[i] = [x<sub>i</sub>, y<sub>i</sub>, q<sub>i</sub>]</code> represents the coordinates <code>(x<sub>i</sub>, y<sub>i</sub>)</code> and quality factor <code>q<sub>i</sub></code> of the <code>i<sup>th</sup></code> tower.</p>

<p>You are also given an integer array <code>center = [cx, cyâââââââ]</code> representing your location, and an integer <code>radius</code>.</p>
...
<ul>
	...
	<li><code>0 &lt;= x<sub>i</sub>, y<sub>i</sub>, q<sub>i</sub>, cx, cy &lt;= 10<sup>5</sup></code>âââââââ</li>
